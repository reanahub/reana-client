...
# MIT License
"""Docker-style names generator, ported to Python."""
...
right = [
    ...
    # astronomy. https://en.wikipedia.org/wiki/Mu%E1%B8%A5ammad_ibn_J%C4
    # %81bir_al-%E1%B8%A4arr%C4%81n%C4%AB_al-Batt%C4%81n%C4%AB
    'albattani',
    ...
    # woman—and first American woman—to win a Nobel Prize in science,
    # and the first woman to be awarded the Nobel Prize in Physiology or
    ...
    # Curran was a Welsh scientist who developed radar and invented chaff,
    # a radar countermeasure. https://en.wikipedia.org/wiki/Joan_Curran
    ...
    # Smalltalk language. https://en.wikipedia.org/wiki/Adele_Goldberg_(
    # computer_scientist)
    'goldberg',
    ...
    # vehicle technology - https://en.wikipedia.org/wiki/A._P._J._Abdul_Kalam
    'kalam',
    ...
    # Daniel Lewin -  Mathematician, Akamai co-founder, soldier,
    # 9/11 victim-- Developed optimization techniques for routing traffic on
    #  the internet. Died attempting to stop the 9-11 hijackers.
    ...
    # Barbara McClintock - a distinguished American cytogeneticist,
    # 1983 Nobel Laureate in Physiology or Medicine for discovering
    ...
    # #Statistics_and_sanitary_reform
    'nightingale',
    ...
    # http://www.businessinsider.com/poppy-northcutt-helped-apollo
    # -astronauts-2014-12?op=1
    'northcutt',
    ...
    # #Comparison_with_modern_formal_systems
    'panini',
    ...
    # in stars - https://en.wikipedia.org/wiki/Meghnad_Saha
    'saha',
    ...
    # in 1955. On his birthday, 15 September is celebrated as Engineer's Day
    #  in India in his memory - https://en.wikipedia.org/wiki/Visvesvaraya
    'visvesvaraya',
    ...
    # embryonic development. https://en.wikipedia.org/wiki/Christiane_N%C3
    # %BCsslein-Volhard
    'volhard',
...
def get_random_name(sep='_'):
    """Return random, docker-style name."""
